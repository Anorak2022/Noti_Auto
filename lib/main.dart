                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      style:
                          TextStyle(color: Color.fromARGB(255, 224, 160, 21)),
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        backgroundColor:
                            const Color.fromARGB(209, 206, 121, 25),
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Color.fromARGB(255, 224, 160, 21),
                        backgroundColor: Color.fromARGB(209, 206, 121, 25),
                      ...
                      child: ClipRRect(
                          ...
                          child: Container(
                              ...
                              child: LinearProgressIndicator(
                                minHeight: 2,
                                backgroundColor:
                                    Color.fromARGB(255, 61, 83, 94),
                                valueColor: AlwaysStoppedAnimation(
                                    Color.fromARGB(255, 224, 160, 21)),
                              )))),
                  Container(
                    height: 30,
                    child: ElevatedButton(
      ...
      try {
        ...
        if (user == "irvin@gmail.com") {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => new adminmenu()));
          setState(() {
            _cambiarEstadoIndicadorProgreso();
          });
        } else {
